...
namespace OnlineExamApp.Controllers
{
    public class TrainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,ContactNo,Email,AddressLine1,AddressLine2,City,PostalCode,Country,LeadTrainer,OrganizationId,ImagePath")] Trainer trainer)
        {
